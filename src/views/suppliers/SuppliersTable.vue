<template>
  <div>
    <AppTable :headers="headers" :items="suppliers" :is-loading="loading" :row-clickable="false">
      ...
      <template #cell-actions="{ item }">
        <div class="flex items-center gap-3">
          ...
          <button
            @click="$emit('delete-supplier', item)"
...
const formatCurrency = (value) => {
  ...
  return Number(value).toLocaleString('ar-SA', { minimumFractionDigits: 2 })
}
</script>
